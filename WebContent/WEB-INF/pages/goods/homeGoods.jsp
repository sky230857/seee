                    ...
                    <a href="<%=basePath%>goods/homeGoods">
                        <div class="bannerimg">
                            <ul class="bannerul">
                                ...
                                <p class="text2">欢迎来到【游淘网】网游账号市场。漫游在虚拟世界的</p>
                                <p class="text3">你，是否有已经厌倦的游戏，为了大家能追求更好的游戏体</p>
                                <p class="text4">验，我们打造了一个全新的交易平台——<span>游淘网网游账号市场</p>
                                <p class="text5">这里有更多的账号分享，更自由的网游话题讨论，你想要的游戏，都在这里。</p>
                                <p class="text6">加入游淘网网游账号市场，你的游戏，应更自由。</p>
                            </ul>
                          <!--   <div class="logoimg">
